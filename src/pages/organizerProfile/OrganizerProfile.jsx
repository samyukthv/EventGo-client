...
import profile from "../../assets/images/avathar2.png";
...
function OrganizerProfile() {
  ...
  useEffect(() => {
    const response = organizerDetails(organizerId).then((response) => {
...
const follow =async(req,res)=>{
                ...
                <div className="flex flex-wrap justify-center ">
                  <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center ">
                    <div className="relative">
                     {organizer? <img
                        alt=""
                        src={organizer.image.slice(0, 33) ===
                            "https://lh3.googleusercontent.com"
                              ? organizer.image
                              : organizer.image
                              ? `${PROFILE_URL}${organizer.image}`
                              : img}
                        className="shadow-xl rounded-full h-28 align-middle border-none absolute -m-12 -mr-10 max-w-150-px"
                      />:null}
                    </div>
                  </div>
  ...
  <Tooltip content="Follow">
    <div className="flex items-center justify-center mx-4">
      <a href={organizer.facebook} target="_blank" rel="noopener noreferrer">
...
{organizer && organizer.instagram && (
  <Tooltip content="Follow">
    <div className="flex items-center justify-center mx-4">
      <a href={organizer.instagram} target="_blank" rel="noopener noreferrer">
