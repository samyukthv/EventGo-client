...
<LazyLoad  offset={200}>
    ...
    <div  className="w-full h-[70vh]" >
            <img src={banner?banner[0].image:null} alt="" className='w-full h-[70vh] object-cover' />
            <div className='max-w-[1140px] m-auto'>
                <div className="absolute top-[30%] w-full md:-[50%] max-w-[600px] h-full flex flex-col text-white p-4">
                    <h1 className='font-bold text-4xl  bg-gradient-to-b from-violet-500 to-pink-100  text-transparent bg-clip-text'>"{banner?banner[0].title:null}"</h1>
                    ...
                    <p>
                    {banner?banner[0].description:null}
                     </p>
                </div>
            </div>
        </div>
