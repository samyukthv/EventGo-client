...
import image from "../../assets/images/nainoa-shizuru-NcdG9mK3PBY-unsplash.jpg"
    ...
    <div className="w-full h-[70vh]">
            ...
            <div className='max-w-[1140px] m-auto'>
                <div className="absolute top-[30%] w-full md:-[50%] max-w-[600px] h-full flex flex-col text-white p-4">
                    <h1 className='font-bold text-4xl  bg-gradient-to-b from-violet-500 to-pink-100  text-transparent bg-clip-text'>"Plan your next event with ease."</h1>
