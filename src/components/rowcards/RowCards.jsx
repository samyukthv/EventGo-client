...
import signupimg from "../../assets/images/1131w-54Tdz9HHh8w.webp";

function RowCards() {
  return (
<div className="mt-5 flex flex-wrap justify-center sm:justify-evenly">



  <div className="w-full sm:w-60 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <img className="rounded-t-lg" src={signupimg} alt="" />

    <div className="flex flex-col items-center justify-center rounded-bl-lg rounded-br-lg">
