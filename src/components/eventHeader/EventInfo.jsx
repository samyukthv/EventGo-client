...
function EventInfo() {
  ...
  const [timeDifference, setTimeDifference] = useState(getTimeDifferenceInSeconds(event.startDate));
  ...
  return (
<div className="pb-5 pt-5 bg-gradient-to-r from-fuchsia-100 to-cyan-100" style={{
      ...
      >
        ...
        <div className="mx-auto max-w-md text-center  lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
         ...
         <span className="">  <ion-icon name="time-outline"></ion-icon> </span>
          ...
          <p className="  leading-8 text-white text-lg"> <span ><ion-icon className="mb-5" name="location-outline"></ion-icon> </span> {location ? location : null}</p>
  ...
  <Link to={`/booking/${event ? event._id : null}`}>
    ...
    >
      Book Now
            ...
            <small className=" leading-8 text-red-600">*{event.ticketQuantity} tickets left</small>
          </div>
        </div>
    ...
    <li className="flex flex-col sm:flex-row justify-between gap-x-6 py-5">
      ...
      <div className="flex flex-col items-center sm:flex-row sm:items-center md:flex-row">
        <div className="mb-4 sm:mb-0">
          <Link to={`/organizer-profile/${organizer ? organizer._id : null}`}>
            <button
              type="button"
